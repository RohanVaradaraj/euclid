...
bins=np.linspace(0.1, 5.5, 50)

# Plot the star and random coords
# plt.figure(figsize=(10, 8))
# plt.scatter(star_pix_coords[:, 0], star_pix_coords[:, 1], s=1, label='Stars')
# plt.scatter(rand_pix_coords[:, 0], rand_pix_coords[:, 1], s=1, label='Random points')
# plt.legend()
# plt.xlabel('X')
# plt.ylabel('Y')
# plt.show()
...
# plt.hist(rand_weights, bins=bins, histtype='step', lw=2.5, label='Random points', density=False)
# plt.legend()
