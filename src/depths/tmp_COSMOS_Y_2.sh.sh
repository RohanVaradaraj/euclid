#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu 21 Mar 13:45:45 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=9216 nice -n 10 /mnt/vardy/vardygroupshare/rohan/euclid/src/depths/./tmp_COSMOS_Y_2.sh 
  echo ---------------                                           
