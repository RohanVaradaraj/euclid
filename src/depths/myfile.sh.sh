#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon 25 Mar 13:21:35 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=10240 nice -n 10 /mnt/vardy/vardygroupshare/rohan/euclid/src/depths/./myfile.sh 
  echo ---------------                                           
