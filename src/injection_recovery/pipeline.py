...
def RunFullInjectionRecoveryPipeline(base_image, overwrite=True):
    ...
    lf_config = config['luminosity_function'] #? All LF parameters such as DPL/Schechter, alpha,beta,n_samples, and delta_Muv.
    ...
    if inject_sources:
        ...
        #? Remove previous images if we are overwriting.
        if overwrite_cats:
