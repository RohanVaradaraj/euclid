#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu 16 Apr 13:08:48 BST 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=15360 nice -n 10 /mnt/vardy/vardygroupshare/rohan/euclid/src/injrec_sed_fitting/./shell_scripts/injrec_sed_all_matched_catalogues_XMM3.sh 
  echo ---------------                                           
