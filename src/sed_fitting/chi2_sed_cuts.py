...
condition_4 = lbg_table[:]['col6'] < bd_table[:]['col21'] # chi2 of high-z solution is less than chi2 of BD solution

good_lbg = lbg_table[:][condition_1 & condition_2 & condition_3 & condition_4]
