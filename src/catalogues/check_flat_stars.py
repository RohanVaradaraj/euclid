...
# plt.figure(figsize=(10, 6))
# plt.errorbar(Y, Y-Ye, yerr=dYYe, xerr=dY, fmt='o', color='black', markersize=5)
...
# plt.xlabel(r'$Y$')
# plt.ylabel(r'$Y - Y_{\rm e}$')
# plt.ylim(-0.5, 0.5)
# plt.show()
# plt.close()

# plt.figure(figsize=(10, 6))
# plt.errorbar(J, J-Je, yerr=dJJe, xerr=dJ, fmt='o', color='black', markersize=5)
# plt.plot([min(J), max(J)], [-0.1, -0.1], color='red', linestyle='dotted')
# plt.plot([min(J), max(J)], [0, 0], color='red', linestyle='--')
# plt.plot([min(J), max(J)], [0.1, 0.1], color='red', linestyle='dotted')
# plt.title(r'$| Y - J| < 0.05 \wedge |J - H| < 0.05$')
# plt.xlabel(r'$J$')
# plt.ylabel(r'$J - J_{\rm e}$')
# plt.ylim(-0.5, 0.5)
# plt.show()
# plt.close()
