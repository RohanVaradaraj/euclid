...
def filter_files(field_name='COSMOS'):
    ...
    if 'CDFS' in field_name:
        filt_files = {
            'u':'myfilters/VST/vst_u.txt',
            'g':'myfilters/VST/vst_g.txt',
            'r':'myfilters/VST/vst_r.txt',
            'i':'myfilters/VST/vst_i.txt',
            'HSC-G':'myfilters/HSC/g_HSC.txt',
            'HSC-R':'myfilters/HSC/r_HSC.txt',
            'HSC-I':'myfilters/HSC/i_HSC.txt',
            'HSC-Z':'myfilters/HSC/z_HSC.txt',
            'Y':'myfilters/VISTA/VISTA_Y.txt',
            'J':'myfilters/VISTA/VISTA_J.txt',
            'H':'myfilters/VISTA/VISTA_H.txt',
            'Ks':'myfilters/VISTA/VISTA_Ks.txt',
            'VIS_Q1':'myfilters/Euclid/Euclid_VIS.txt',
            'YE_Q1':'myfilters/Euclid/Euclid_Y.txt',
            'JE_Q1':'myfilters/Euclid/Euclid_J.txt',
            'HE_Q1':'myfilters/Euclid/Euclid_H.txt',
        }
