#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri 22 Mar 14:26:58 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=20480 nice -n 10 /mnt/vardy/vardygroupshare/rohan/euclid/src/file_management/./myfile.sh 
  echo ---------------                                           
