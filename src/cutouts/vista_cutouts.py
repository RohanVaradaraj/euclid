...
def VistaCutout(ra: float, dec:float, contained_in: Optional[np.array] = None, size: float = 10.0, 
    ...
    for i, cutout in enumerate(cutouts):
        ...
        ax[i//7, i%7].imshow(cutout.data, origin='lower', cmap='gist_yarg', vmin=vmin, vmax=vmax)
        ax[i//7, i%7].set_title(cutout.wcs.wcs.ctype[0])
